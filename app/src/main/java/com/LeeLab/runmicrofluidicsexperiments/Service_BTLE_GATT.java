...
public class Service_BTLE_GATT extends Service {
    ...
    public final static String EXTRA_UUID = "service_BTLE_GATT.EXTRA_UUID";
    public final static String EXTRA_DATA = "service_BTLE_GATT.EXTRA_DATA";
    ...
    private final BluetoothGattCallback mGattCallback = new BluetoothGattCallback() {
        ...
        public void onCharacteristicChanged(BluetoothGatt gatt,
                                            BluetoothGattCharacteristic characteristic) {
            Log.i("~~~~~~~!!!!!!!", "onCharacteristicCHANGED callback fire");
            broadcastUpdate(ACTION_DATA_AVAILABLE, characteristic);
        }
...
//        }
    ...
    public void onCreate() {
        //Commented out by me. This might have been one of the toasts spamming nonstop even after app close?
        //Probably should figure out why if you have time...
        //Toast.makeText(getApplicationContext(), "Service_BTLE_GATT activity launched", Toast.LENGTH_LONG).show();
    }
    ...
    public void readCharacteristic(BluetoothGattCharacteristic characteristic) {
        ...
        Log.i("~~~~~~~~~~~~~~~~", "You called readCharacteristic");
